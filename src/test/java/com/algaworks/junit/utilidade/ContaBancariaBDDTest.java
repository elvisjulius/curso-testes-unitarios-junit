...
public class ContaBancariaBDDTest {
    ...
    @Nested
    @DisplayName("Dado uma conta bancárias com saldo de R$ 10,00")
    class ContaBancariaComSaldo{
        ...
        @Nested
        @DisplayName("Quando efeturar o saque com valor menor")
    ...
    @Nested
    @DisplayName("Dado uma conta bancárias com saldo de R$ 0,00")
